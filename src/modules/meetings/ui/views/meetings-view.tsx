...
export const MeetingsView = () => {
    ...
    return (
        <div className="flex-1 pb-4 px-4 md:px-8 flex flex-col gap-y-4">
            ...
            />
            {data.items.length === 0 && (
                    <EmptyState title="Create your first meetings." description="Schedule a meeting to connect with others. Each meeting lets you collabrate, share ideas, and interact with pariticipants in real time."/>
              )}
        </div>
    );
}
